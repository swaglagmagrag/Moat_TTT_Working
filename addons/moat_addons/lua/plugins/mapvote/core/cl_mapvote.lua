...
function MapVote.Show()
    ...
    function like:Paint(w,h)
        cdn.DrawImage("E3Fa8uDCgNzzL6iAoITcNk4nUDye.png",0,0,w,h,Color(0,255,0,50))
    end
    ...
    like:SetText("")
    function like:Paint(w,h)
        cdn.DrawImageRotated("unE9uyhsKtr835pF3Zigc71KozFU.png",0,0,w,h,Color(255,0,0,50),180,50)
    end
    function like:DoClick()
        hasvoted = true
        net.Start("MapVote.Feedback")
    ...
    for i = 1,8 do
        ...
        a:Dock(LEFT)
        local url = "3ecf354904aa3d512f22f3b5d53d4079.png"
        a:SetText("")
        local ispic = false
        http.Fetch("https://image.gametracker.com/images/maps/160x120/garrysmod/" .. map .. ".jpg",function(_,_,_,c) 
            if not tostring(c):match("^2") then 
                url = "3ecf354904aa3d512f22f3b5d53d4079.png"
            else
                url = "https://image.gametracker.com/images/maps/160x120/garrysmod/" .. map .. ".jpg"
            end 
        end,function() url = "3ecf354904aa3d512f22f3b5d53d4079.png" end)
        function a:Paint(w,h)
            ...
            if (url == "3ecf354904aa3d512f22f3b5d53d4079.png") then
            ...
            /*if (MapVote.Feedback[map] and MapVote.Feedback[map].Positive and MapVote.Feedback[map].Negative) then
        		...
        		cdn.DrawImage("E3Fa8uDCgNzzL6iAoITcNk4nUDye.png",10,148 + 9,20,20,Color(255,255,255,25))
				cdn.DrawImageRotated("unE9uyhsKtr835pF3Zigc71KozFU.png",(w/2)+10,148 + 9,20,20,Color(255,255,255,25),180,50)
            else

...
MOAT_DONATE.BackgroundURL = "7b41d8391eef24d3cba3e36063f91b2a.png"
...
function MOAT_DONATE:DrawRewardsInfo(pnl, pkg, clr)
    ...
    --cdn.DrawImage("cWeit2ZL5WhFze49xX7jV76mFvOG.png", (w/2) - (235/2), 55, 254, 235)
    ...
    function steam:Paint(w, h)
        ...
        surface.DrawTexturedRect(0, 0, w, 45)
        surface.DrawOutlinedRect(0, 0, w, 45)
        cdn.DrawImageRotated("c2bcd70c9d30a6e54fe5d9d1d837dc7f.png", 10, 4, 35, 35, nil, math.sin(CurTime()) * 15, true)
    ...
    function steam:Paint(w, h)
        ...
        surface.DrawTexturedRect(0, 0, w, 45)
        surface.DrawOutlinedRect(0, 0, w, 45)
        cdn.DrawImageRotated("96a5bf04d72376b51cae473b2d051f54.png", 10, 4, 35, 35, nil, math.sin(CurTime() + 10) * 15, true)

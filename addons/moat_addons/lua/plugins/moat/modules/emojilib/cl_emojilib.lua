...
local function AddEmoji(height, url, ...)
    for i = 1, select("#", ...) do
        ...
        emojis[emoji] = url:match"(%.[^%.]+)$" and url or string("/emojis/" .. url .. ".png")
...
-- AddEmoji(21, "30377462080281024722.gif", ":tv:", "📺")
-- AddEmoji(21, "/emoticons/smiley_registered_trademark/happy-smile.png", ":)", ":]", "}")

AddEmoji(21, "/emoticons/smiley_registered_trademark/halloween-pumpkin-1.png", ":pumpkin:")
AddEmoji(21, "/emoticons/smiley_registered_trademark/halloween-pumpkin-2.png", ":pumpkin~1:")
AddEmoji(21, "/emoticons/smiley_registered_trademark/halloween-pumpkin-3.png", ":pumpkin~2:", "🎃")
AddEmoji(21, "/emoticons/smiley_registered_trademark/halloween-pumpkin-4.png", ":pumpkin~3:")
AddEmoji(21, "74627770687536266043.png", "Loading...")

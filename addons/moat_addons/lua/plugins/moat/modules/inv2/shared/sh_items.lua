...
function m_CreatePaints()
	for k , v in pairs(MOAT_PAINT.Tints) do
        ...
        tbl.PaintVer = 1
        tbl.Image = v[4] or "dc118c40e7e7f5a37d4d37c5e0533c8a.png"
        tbl.ItemCheck = 11
	...
	for k, v in pairs(MOAT_PAINT.Paints) do
        ...
        tbl.Collection = "Paint Collection"
        tbl.PaintVer = 2
        tbl.Image = v[4] or "ed180ad2d90f58198e6159edde738131.png"
        tbl.ItemCheck = 10
        function tbl:ItemUsed(pl, slot, item)
	...
	for k, v in pairs(MOAT_PAINT.Skins) do
        ...
        tbl.PaintVer = 2
        tbl.Image = v[4] or "2198b5d9d5c8a1e35fe2a4c833556fd6.png"
        tbl.ItemCheck = 12
        function tbl:ItemUsed(pl, slot, item)

...
function MOAT_EVENT.SQL.FormatQuery(str, ...)
    ...
    str = str:gsub("#", function()
        ...
        return MOAT_EVENT.SQL.Escape(args[arg])
    end)
...
MOAT_EVENT.WeaponsChallenges = {
    ...
    ["weapon_ttt_badger"] = {200, 125, 125, 100, 125, 38, 27, 500},
...
MOAT_EVENT.WeaponRewards = {"Novice", "Amateur", "Apprentice", "Professional", "Master", "Expert", "Legend", "God"}
...
net.Receive("moat.events.top", function(_, pl)
    if (pl.RequestedEventsTop) then return end

...
local bomb_sounds = {
    ["win"] = "9PIiSvHopONR7egMCMSzWCbhgzTo.mp3",
    ["boom"] = "f0VWNHpOfBrTK8SzNu4OP6Qqaj2w.mp3",
    ["end"] = "oa2TST8otq3qoHg1VzfNkbJmu4OZ.mp3",
	["versus_win"] = "moat_versus_win_pn.mp3",
	[1] = "HFYN4ZEEuObwgbs7yoO7UmvgUG9B.mp3",
	[2] = "JLbZfNntpdmPOrcRcdRnWDdEG5iU.mp3",
}
		...
		for x = 0,4 do
			...
			BTN2.Paint = function(s, w, h)
				...
				elseif mines[s.i] == -1 then
                    ...
                    cdn.DrawImage("mg_bomb.png", 0, 0, 64, 64)
				end
				--draw.SimpleText(bombs[i], "Trebuchet24", w/2, h/2, cols[3], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
			end
			BTN2.DoClick = function(s, w, h)
...
local fsize = 505, 460
local mats = {
    wheel = "KrsoP3vZn2GJoyHK2yidAT4roLe5.png",
    mat_green_normal = "hMJafIYykyzKw2daM8zXwICHN4Kq.png",
    mat_green_red = "m1z4PprRigdVQIZ3yNg7pUUgM69P.png",
    mat_green_black = "91DaxiCjyvv7ACrgUT7di8IzOD0I.png",
    mat_green_normal_hover = "WJhJgSHgT3Yh6q42SZwdcoBtyVg1.png",
    mat_green_black_hover = "jECkhuCfEbRiuACRvPXr3FWoHMfi.png",
    mat_green_red_hover = "7oKAmGxFqozCePoq8EiRbkxYyoxT.png"
}

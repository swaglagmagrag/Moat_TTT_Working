...
MOAT_EVENT.ChalColors = {Color(0, 0, 255), Color(255, 0, 255), Color(255, 0, 0), Color(255, 255, 0), Color(0, 255, 0)}

MOAT_EVENT.TopPlayers = MOAT_EVENT.TopPlayers or {}

MOAT_EVENT.Challenges = {"Obtain {num} rightful kills as a terrorist with any {weapon} as the weapon of death.", "Obtain {num} headshot kills as a terrorist with any {weapon} as the weapon of death.", "Obtain {num} rightful kills as a terrorist with a Standard {weapon} as the weapon of death.", "Obtain {num} headshot kills as a terrorist with a Specialized {weapon} as the weapon of death.", "Obtain {num} rightful kills while crouched with any {weapon} as the weapon of death.", "Obtain {num} double kills as a terrorist with a High-End {weapon} as the weapon of death.", "Obtain {num} penta-killstreaks rightfully with a High-End {weapon} as the weapon of death.", "Obtain {num} rightful kills as a terrorist with any {weapon} as the weapon of death."}
...
MOAT_EVENT.Tabs = {
    ...
    --{"Group", MOAT_EVENT.GroupPanel}, --{"Invites", MOAT_EVENT.InvitePanel}, --{"Manage", MOAT_EVENT.ManagePanel},

...
local death_voices = {"u4QUxAtoqhJMNdLKoCDFnfFJOgfj.mp3", "DuUQdR6b6IPLuDBoUffUb3GcO7kF.mp3", "o66GU9avCtjwXkEWnrKZTRpj0A7A.mp3", "es1VgqnzB8rkdFbbvjxrpjpXmAmM.mp3", "HNGJ1QHKrDFgxEKezZwDqDnHCGKu.mp3", "3TjV4QhosYjCyGjhTHuaOBYCEYW3.mp3", "Zy6k5NHOUkbWXWlRqjFZU5ovMkVs.mp3", "vXHWudEuRy7azKDjfN3rP6LUIwZU.mp3", "ABOKrPTwS5ctIr0rcfa9r5FzheSo.mp3", "BnEx3kkGamjarHGak9ZY6TsdMQc4.mp3", "vOdDwekeqfqY7jHpvzHaoeFY4uih.mp3"}
local boss_voices = {"FQ8Ki3DI1iwz7COGvb3lJDGNjvqi.mp3", "d498NmYGCidzOhk5eKIwjCZnLiG1.mp3", "AlbmDVfwYncLe73Cy4NbTBiOdtzQ.mp3", "VLnfWX6R7qms2nXqixIb8MpHKfYz.mp3", "2C8JVERC0wo61c57IUYfesggbNI8.mp3", "WWKrz7PvhSNnMKpl8BZWHhzp6sK9.mp3", "VSh7wIfUcx7tD9Pp7kJJ2uXQolro.mp3", "XUk6mFPFkFr4eL9B3fJ7I9iLY17b.mp3", "vHJAQrx7C07ykA4stEeglMN8SjWN.mp3"}
...
local function moat_BossPlayerDeath(ply)
	...
	if (not IS_BOSS) then
		-- cdn.PlayURL("ubbd7fKB9WdDWbk5J1QMC3iM81GG.mp3", 2)
		...
		-- cdn.PlayURL("9582v2jF3CQSP5fOM44CuAE3TMVr.mp3", 2)
	end
...
local function moat_BeginRoundBossHooks()
	...
	hook.Add("ttt.BeginRound", "moat_BossBeginRound", function()
		...
		timer.Simple(1, function()
			MuteForRestart(true)
			-- cdn.PlayURL(table.Random({"tFU5O424OaHTrU16ayw6NJz3x4Lz.mp3", "q5ZZXsMohK3L3b0lnaKQ88SUPOUZ.mp3"}), 2)
		end)
